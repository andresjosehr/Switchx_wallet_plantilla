...
<script>
   ...
   function updateColorHeader() {
    if ($(window).scrollTop() > 80) {
    	...
    	$(".header").removeClass("header_no-scroll");

    	$(".header__menu").addClass("menu_scroll");
    	$(".header__menu").removeClass("menu_no-scroll");

    }
    else{

    	$(".header").removeClass("header_scroll");
    	$(".header").addClass("header_no-scroll");

    	$(".header__menu").removeClass("menu_scroll");
    	$(".header__menu").addClass("menu_no-scroll");
